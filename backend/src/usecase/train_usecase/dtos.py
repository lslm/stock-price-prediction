...
class RequestTrain(BaseModel):
    ...
    lookback: int = Field(title="LookBack", description="Quantidade de dados que serão utilizados para prever o próximmo passo", ge=100, le=365, default=365)
    epoch: int = Field(title="Epochs", description="Quantidade de Epochs utilizadas para o treinamento", ge=10, le=100)
